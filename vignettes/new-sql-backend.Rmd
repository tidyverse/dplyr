...
If you read the source code for the real `src_postgres()` you'll notice that it caches the `dbGetInfo()` field on creation, since this saves a little time when printing tbls.
