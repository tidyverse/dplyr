...
I think the closest base R equivalent is `by()`. Unfortunately `by()` returns a list of data frames, but you can combine them back together again with `do.call()` and `rbind()`:
...
You can see a variety of other options at <https://gist.github.com/hadley/c430501804349d382ce90754936ab8ec>, many generated by the R community  and 
