...
`rowwise()` data frames allow you to solve a variety of modelling problems in what I think is a particularly elegant way. We'll start by using:
...
* Without argument names: you could call functions that input and output 
  ...
  superseded by the combination of `across()` plus the more permissive 
