...
In practice, the formula is the better of the two options because captures the code and its execution __environment__. This important because even a simple expression can yield different values in different environments. For example, the `x` in the following two expressions refers to different values:
