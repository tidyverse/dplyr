...
<-- {JR} {Is the expectation that the reader is familiar with the `.data` pronoun by the time they read this? If not, it might be helpful to: include a hyperlink to more docs that explain what it is, add a "You can learn more about pronouns in `?.data`" sentence, or move your addendum (down below under "Loop over multiple variables") further up to this first mention of `.data`. Otherwise, I think it's pretty clear for users familiar with pronouns. } -->
