...
*   To teach you the underlying theory including __quosures__, the data 
    ...
    and __rlang__, the underlying toolkit.
...
In dplyr (and in the rlang in general) you use `!!` to say that you want to unquote an input so that it's evaluated, not quoted. This gives us a funtion that actually does what we want.
...
Now that you've learned the basics of rlang through some practical examples, we'll dive into the theory. This will help you generalise what you've learned here to new situations.
...
Quasiquotation was coined by Willard van Orman Quine in the 1940s, and was adopted for programming by the LISP community in the 1970s. All expression-based functions in the rlang framework support quasiquotation. Unquoting cancels quotation of parts of an expression. There are three types of unquoting:
...
You can safely unquote quosures because they track their environments, and rlang functions know how to evaluate them. This allows any depth of quoting and unquoting.
