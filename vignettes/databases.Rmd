...
You can also ask the database how it plans to execute the query with `explain_tbl()`. The output for SQLite is explained in more detail on the [SQLite website](http://www.sqlite.org/eqp.html) and is helpful if you're trying to figure out what indexes are being used.
