...
The nycflights13 package contains a special function that essentially repeats the above `copy_to()` function for all of the tables it contains. Then it caches them to speed things up:

```{r}
flights_sqlite <- tbl(nycflights13_sqlite(), "flights")

Caching nycflights db at C:\Users\muenchen\AppData\Local\Temp\RtmpIP2ZeB/nycflights13.sqlite
...
You can also query `tbl` from arbitrary SQL:
