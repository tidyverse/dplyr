...
I'm not aware of a single line data table equivalent ([see SO 16573995](http://stackoverflow.com/questions/16573995/)). Suggetions welcome.
...
We conclude with some quick comparisons of joins. There are few equivalents in base R or with straightforward data table commands.  First we create two new datasets: `master` which contains demographic information on each player, and `hall_of_fame` which contains all players inducted into the hall of fame.
