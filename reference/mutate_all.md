...
of [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) and
[`transmute()`](https://dplyr.tidyverse.org/reference/transmute.md) make
it easy to apply the same transformation to multiple variables. There
are three variants:
