...
[`vars()`](https://dplyr.tidyverse.org/reference/vars.md) selection
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md). See
  [`filter_all()`](https://dplyr.tidyverse.org/reference/filter_all.md).

- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md). See
  [`group_by_all()`](https://dplyr.tidyverse.org/reference/group_by_all.md).

- [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) and
  [`select()`](https://dplyr.tidyverse.org/reference/select.md). See
  [`select_all()`](https://dplyr.tidyverse.org/reference/select_all.md).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md). See
  [`arrange_all()`](https://dplyr.tidyverse.org/reference/arrange_all.md)
...
- Verbs suffixed with `_at()` apply an operation on a subset of
  ...
  [`vars()`](https://dplyr.tidyverse.org/reference/vars.md). This
  quoting function accepts
  [`tidyselect::vars_select()`](https://tidyselect.r-lib.org/reference/vars_select.html)
  helpers like
  [`starts_with()`](https://tidyselect.r-lib.org/reference/starts_with.html).
  Instead of a [`vars()`](https://dplyr.tidyverse.org/reference/vars.md)
...
- [`arrange_all()`](https://dplyr.tidyverse.org/reference/arrange_all.md),
  ...
  and
  [`arrange_if()`](https://dplyr.tidyverse.org/reference/arrange_all.md)
...
- [`filter_all()`](https://dplyr.tidyverse.org/reference/filter_all.md),
  [`filter_at()`](https://dplyr.tidyverse.org/reference/filter_all.md),
  and
  [`filter_if()`](https://dplyr.tidyverse.org/reference/filter_all.md)

- [`group_by_all()`](https://dplyr.tidyverse.org/reference/group_by_all.md),
  [`group_by_at()`](https://dplyr.tidyverse.org/reference/group_by_all.md),
  and
  [`group_by_if()`](https://dplyr.tidyverse.org/reference/group_by_all.md)

- [`select_all()`](https://dplyr.tidyverse.org/reference/select_all.md),
  [`select_at()`](https://dplyr.tidyverse.org/reference/select_all.md),
  and
