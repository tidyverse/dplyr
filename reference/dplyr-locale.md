...
[`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) when
ordering character vectors.

### Default locale

The default locale used by
[`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) is the C
locale. This is used when `.locale = NULL` unless the deprecated
