...
combination of
[`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) (which
can produce multiple rows and multiple columns),
[`nest_by()`](https://dplyr.tidyverse.org/reference/nest_by.md) (which
creates a [rowwise](https://dplyr.tidyverse.org/reference/rowwise.md)
tibble of nested data), and
[`pick()`](https://dplyr.tidyverse.org/reference/pick.md) (which allows
you to access the data for the "current" group).
