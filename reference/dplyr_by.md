...
[`ungroup()`](https://dplyr.tidyverse.org/reference/group_by.md) after
...
- [`mutate(.by = )`](https://dplyr.tidyverse.org/reference/mutate.md)

- [`summarise(.by = )`](https://dplyr.tidyverse.org/reference/summarise.md)

- [`reframe(.by = )`](https://dplyr.tidyverse.org/reference/reframe.md)

- [`filter(.by = )`](https://dplyr.tidyverse.org/reference/filter.md)

- [`filter_out(.by = )`](https://dplyr.tidyverse.org/reference/filter.md)

- [`slice(.by = )`](https://dplyr.tidyverse.org/reference/slice.md)

- [`slice_head(by = )`](https://dplyr.tidyverse.org/reference/slice.md)
  and
  [`slice_tail(by = )`](https://dplyr.tidyverse.org/reference/slice.md)

- [`slice_min(by = )`](https://dplyr.tidyverse.org/reference/slice.md)
  and
  [`slice_max(by = )`](https://dplyr.tidyverse.org/reference/slice.md)

- [`slice_sample(by = )`](https://dplyr.tidyverse.org/reference/slice.md)

Note that some dplyr verbs use `by` while others use `.by`. This is a
purely technical difference.

### Differences between `.by` and [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)

|                                                                                                  |                                                                                                    |
|--------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| `.by`                                                                                            | [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)                                  |
| Grouping only affects a single verb                                                              | Grouping is persistent across multiple verbs                                                       |
| Selects variables with [tidy-select](https://dplyr.tidyverse.org/reference/dplyr_tidy_select.md) | Computes expressions with [data-masking](https://rlang.r-lib.org/reference/args_data_masking.html) |
...
`.by` works with a number of other dplyr verbs. For example, you could
append the mean cost per region onto the original data frame as a new
column rather than computing a summary:
...
When used with `.by`,
[`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md),
[`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md), and
[`slice()`](https://dplyr.tidyverse.org/reference/slice.md) all maintain
the ordering of the existing data. This is different from
[`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md), which
has always sorted the group keys in ascending order.
...
[`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) either
before or after the call to
[`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md),
[`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md), or
[`slice()`](https://dplyr.tidyverse.org/reference/slice.md). This also
gives you full access to all of
[`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md)'s
features, such as
[`desc()`](https://dplyr.tidyverse.org/reference/desc.md) and the
`.locale` argument.
...
[`pull()`](https://dplyr.tidyverse.org/reference/pull.md) and
[`rename()`](https://dplyr.tidyverse.org/reference/rename.md) don't
...
is typically because the verbs are required to retain the grouping
columns, for example:

- [`select()`](https://dplyr.tidyverse.org/reference/select.md) always
  retains grouping columns, with a message if any aren't specified in
  the [`select()`](https://dplyr.tidyverse.org/reference/select.md)
  call.

- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) and
  [`count()`](https://dplyr.tidyverse.org/reference/count.md) place
  unspecified grouping columns at the front of the data frame before
  computing their results.

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) has a
  `.by_group` argument to optionally order by grouping columns first.

If [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
