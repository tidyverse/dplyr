...
Currently,
[`copy_to()`](https://dplyr.tidyverse.org/reference/copy_to.md) is the
only user of `db_begin()`, `db_commit()`, `db_rollback()`,
...
[`copy_to()`](https://dplyr.tidyverse.org/reference/copy_to.md) instead.
