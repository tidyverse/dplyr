...
`nest_by()` returns a
[rowwise](https://dplyr.tidyverse.org/reference/rowwise.md) data frame,
which makes operations on the grouped data particularly elegant. See
...
- ...:
  ...
  In [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md),
...
A [rowwise](https://dplyr.tidyverse.org/reference/rowwise.md) data
...
[`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md)s
multi-row behaviour:
