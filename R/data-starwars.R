...
#' \item{gender}{The gender role or gender indentity of the character as determined by their personality or the way they were progammed (as in the case for Droids).}
