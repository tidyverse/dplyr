...
translate_env.src_greenplum <- function(x) {
  sql_variant(
    ...
    sql_translator(.parent=base_win,
                   mean  = function(x) {
                     over(build_sql(sql("avg"), list(x)), partition_group(), NULL, frame = NULL)
                   },
                   sum   = function(x) {
                     over(build_sql(sql("sum"), list(x)), partition_group(), NULL, frame = NULL)
                   },
                   min   = function(x) {
                     over(build_sql(sql("min"), list(x)), partition_group(), NULL, frame = NULL)
                   },
                   max   = function(x) {
                     over(build_sql(sql("max"), list(x)), partition_group(), NULL, frame = NULL)
                   },
                   n = function() {
...
over.src_greenplum <- function(expr, partition = NULL, order = NULL, frame = NULL) {
