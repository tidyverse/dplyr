...
- [Introduction to
  dplyr](https://dplyr.tidyverse.org/articles/dplyr.md):
...
- [Grouped data](https://dplyr.tidyverse.org/articles/grouping.md):
...
- [Two-table verbs](https://dplyr.tidyverse.org/articles/two-table.md):
...
- [Recoding columns and replacing
  values](https://dplyr.tidyverse.org/articles/recoding-replacing.md):

- [dplyr \<-\> base R](https://dplyr.tidyverse.org/articles/base.md):
...
- [Column-wise
  operations](https://dplyr.tidyverse.org/articles/colwise.md):
...
- [Row-wise
  operations](https://dplyr.tidyverse.org/articles/rowwise.md):
...
- [Programming with
  dplyr](https://dplyr.tidyverse.org/articles/programming.md):
...
- [Window
  functions](https://dplyr.tidyverse.org/articles/window-functions.md):
...
- [Using dplyr in
  packages](https://dplyr.tidyverse.org/articles/in-packages.md):
