...
- Rows:
  ...
  - [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) chooses
    rows based on location.
...
[`filter()`](https://dplyr.tidyverse.org/reference/filter.md) allows you
to select a subset of rows in a data frame. Like all single verbs, the
first argument is the tibble (or data frame). The second and subsequent
arguments refer to variables within that data frame, selecting rows
...
[`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) works
similarly to
[`filter()`](https://dplyr.tidyverse.org/reference/filter.md) except
...
Use [`desc()`](https://dplyr.tidyverse.org/reference/desc.md) to order a
...
[`slice()`](https://dplyr.tidyverse.org/reference/slice.md) lets you
...
- [`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md) and
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md) select
  the rows with the smallest or largest values of the selected column.
  By default, they return a single minimum or maximum, but you can
  supply `n` to control how many rows remain.
...
[`select()`](https://dplyr.tidyverse.org/reference/select.md) allows you
to rapidly zoom in on a useful subset using operations that usually only
...
[`select()`](https://dplyr.tidyverse.org/reference/select.md), like
...
criterion. See
[`?select`](https://dplyr.tidyverse.org/reference/select.md) for more
details.

You can rename variables with
[`select()`](https://dplyr.tidyverse.org/reference/select.md) by using
named arguments:
...
But because
[`select()`](https://dplyr.tidyverse.org/reference/select.md) drops all
the variables not explicitly mentioned, it’s not that useful. Instead,
use [`rename()`](https://dplyr.tidyverse.org/reference/rename.md):
...
[`dplyr::mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) is
similar to the base
...
[`select()`](https://dplyr.tidyverse.org/reference/select.md) to move
blocks of columns at once
...
The last verb is
[`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md). It
...
[`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) verb
below.
...
([`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md)), pick
observations and variables of interest
([`filter()`](https://dplyr.tidyverse.org/reference/filter.md) and
[`select()`](https://dplyr.tidyverse.org/reference/select.md)), add new
...
have the same meaning as the same symbol supplied to
[`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md).

Selecting operations expect column names and positions. Hence, when you
call [`select()`](https://dplyr.tidyverse.org/reference/select.md) with
bare variable names, they actually represent their own positions in the
tibble. The following calls are completely equivalent from dplyr’s point
of view:
...
For a long time,
[`select()`](https://dplyr.tidyverse.org/reference/select.md) used to
only understand column positions. Counting from dplyr 0.6, it now
understands column names as well. This makes it a bit easier to program
with [`select()`](https://dplyr.tidyverse.org/reference/select.md):
...
[`select()`](https://dplyr.tidyverse.org/reference/select.md) expects
column names or positions,
[`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) expects
*column vectors*. We will set up a smaller tibble to use for our
examples.
...
When we use
[`select()`](https://dplyr.tidyverse.org/reference/select.md), the bare
column names stand for their own positions in the tibble. For
[`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) on the
...
[`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) gets
...
[`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md). This
...
A case in point is
[`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md). While
you might think it has select semantics, it actually has mutate
...
[`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md). This
