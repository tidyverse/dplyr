...
|                           | **Recoding**                                                                            | **Replacing**                                                                            |
|---------------------------|-----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| **Match with conditions** | [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)         | [`replace_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)       |
| **Match with values**     | [`recode_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md) | [`replace_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md) |
...
[`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)
and [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) have
`time` as their last input, making the intent a bit hard to understand
at first glance.
...
Similar to
[`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md),
[`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) doesn’t
offer type stability on any particular input. The output’s type is
computed as the common type of `true`, `false`, and `missing`. If you
find yourself writing an
[`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) where
the purpose is to partially update an existing column, consider using
[`replace_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)
...
[`coalesce()`](https://dplyr.tidyverse.org/reference/coalesce.md) are
often a
[`replace_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md)
call in disguise:
