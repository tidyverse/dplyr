...
[`vignette("dplyr")`](https://dplyr.tidyverse.org/articles/dplyr.md).
...
[`dplyr::arrange()`](https://dplyr.tidyverse.org/reference/arrange.md)
...
The [`desc()`](https://dplyr.tidyverse.org/reference/desc.md) helper
...
[`dplyr::distinct()`](https://dplyr.tidyverse.org/reference/distinct.md)
selects unique rows:
...
[`dplyr::filter()`](https://dplyr.tidyverse.org/reference/filter.md)
...
[`dplyr::mutate()`](https://dplyr.tidyverse.org/reference/mutate.md)
...
[`dplyr::pull()`](https://dplyr.tidyverse.org/reference/pull.md)
...
[`dplyr::relocate()`](https://dplyr.tidyverse.org/reference/relocate.md)
...
[`dplyr::rename()`](https://dplyr.tidyverse.org/reference/rename.md)
...
[`dplyr::rename_with()`](https://dplyr.tidyverse.org/reference/rename.md)
...
[`dplyr::select()`](https://dplyr.tidyverse.org/reference/select.md)
...
[`slice()`](https://dplyr.tidyverse.org/reference/slice.md) selects rows
with their location:
...
variety of dplyr
[`join()`](https://dplyr.tidyverse.org/reference/mutate-joins.md)
functions.
