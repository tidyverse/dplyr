...
dplyr is designed to abstract over how the data is stored. dplyr comes with a built-in backend for data frames; other packages provide alternative computational backends:

* For large in-memory datasets, use [dtplyr](http://dbplyr.tidyverse.org/)
  to access the excellent performance of [data.table](http://r-datatable.com/).
  
* For data in relational databases, use [dbplyr](http://dbplyr.tidyverse.org/) 
  to automatically translate your dplyr code in to SQL.
