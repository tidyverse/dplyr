...
- [arrow](https://arrow.apache.org/docs/r) for larger-than-memory datasets with two backend engine options (default engine is [Acero](https://arrow.apache.org/docs/cpp/streaming_execution.html), the Arrow C++ engine, or [DuckDB](https://duckdb.org/))
...
- [duckdb](https://duckdb.org/docs/api/r) or 
  [arrow](https://arrow.apache.org/docs/r/) for large datasets that are 
