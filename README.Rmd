...
- [arrow](https://arrow.apache.org/docs/r) for larger-than-memory datasets with two backend engine options ([Acero](https://arrow.apache.org/docs/cpp/streaming_execution.html), the Arrow C++ engine, and [DuckDB](https://duckdb.org/))
