...
namespace dplyr {
  ...
  class VisitorSetIndexSet : public std::unordered_set<int, VisitorSetHasher<VisitorSet>, VisitorSetEqualPredicate<VisitorSet> > {
  private:
    typedef VisitorSetHasher<VisitorSet> Hasher;
    typedef VisitorSetEqualPredicate<VisitorSet> EqualPredicate;
    typedef std::unordered_set<int, Hasher, EqualPredicate> Base;
