...
* Date/Publication: 2020-10-24 22:20:02 UTC
...
*   checking whether package ‘florestal’ can be installed ... ERROR
    ```
    Installation failed.
...
* Version: 0.0.2
* GitHub: https://github.com/StevenVB12/patternize
* Source code: https://github.com/cran/patternize
* Date/Publication: 2018-11-23 10:50:03 UTC
* Number of recursive dependencies: 86

Run `cloud_details(, "patternize")` for more info
...
* Version: 0.1.7
* GitHub: https://github.com/jeffreyhanson/raptr
* Source code: https://github.com/cran/raptr
* Date/Publication: 2020-07-31 08:20:03 UTC
* Number of recursive dependencies: 141

Run `cloud_details(, "raptr")` for more info
...
* checking package namespace information ... OK
* checking package dependencies ... ERROR
Package required but not available: ‘hypervolume’

Packages suggested but not available: 'gurobi', 'rgl'
...
```
* using log directory ‘/tmp/workdir/raptr/old/raptr.Rcheck’
* using R version 3.6.3 (2020-02-29)
* using platform: x86_64-pc-linux-gnu (64-bit)
* using session charset: UTF-8
* using options ‘--no-manual --no-build-vignettes’
...
* checking package namespace information ... OK
* checking package dependencies ... ERROR
Packages suggested but not available: 'knitcitations', 'metap'
