...
*   checking re-building of vignette outputs ... WARNING
    ...
    Error in re-building vignettes:
      ...
    pandoc: Could not fetch https://i.imgur.com/Wnf015S.png
    TlsExceptionHostPort (HandshakeFailed (Error_Packet_unexpected "Alert [(AlertLevel_Fatal,BadRecordMac)]" " expected: change cipher")) "i.imgur.com" 443
    Error: processing vignette 'bioc-workflow.Rmd' failed with diagnostics:
    pandoc document conversion failed with error 67
    Execution halted
    ```

# select_helpers alias (fixed)
...
*   checking Rd cross-references ... WARNING
    ...
    Missing link or links in documentation object 'rowspecs.Rd':
...
*   checking Rd cross-references ... WARNING
    ...
    Missing link or links in documentation object 'permute.Rd':
      ‘[dplyr]{select_helpers}’
