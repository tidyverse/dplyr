...
- Ranking and ordering functions:
  ...
  and [`ntile()`](https://dplyr.tidyverse.org/dev/reference/ntile.md).
  These functions all take a vector to order by, and return various
  types of ranks.

- Offsets
  [`lead()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) and
  [`lag()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) allow
...
- Cumulative aggregates:
  ...
  [`cumany()`](https://dplyr.tidyverse.org/dev/reference/cumall.md), and
  [`cummean()`](https://dplyr.tidyverse.org/dev/reference/cumall.md)
  (from dplyr).
...
divide the data into buckets for further summary. For example, we could
use [`ntile()`](https://dplyr.tidyverse.org/dev/reference/ntile.md) to
divide the players within a team into four ranked groups, and calculate
...
[`desc()`](https://dplyr.tidyverse.org/dev/reference/desc.md) to rank
from highest to lowest.

## Lead and lag

[`lead()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) and
[`lag()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) produce
...
- Compute differences or percent changes.
  ...
  Using [`lag()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md)
  is more convenient than [`diff()`](https://rdrr.io/r/base/diff.html)
...
[`lead()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) and
[`lag()`](https://dplyr.tidyverse.org/dev/reference/lead-lag.md) have an
...
[`cummean()`](https://dplyr.tidyverse.org/dev/reference/cumall.md), a
cumulative mean. These are not included in base R, but efficient
versions are provided by `dplyr`.

[`cumany()`](https://dplyr.tidyverse.org/dev/reference/cumall.md) and
[`cumall()`](https://dplyr.tidyverse.org/dev/reference/cumall.md) are
useful for selecting all rows up to, or all rows after, a condition is
true for the first (or last) time. For example, we can use
[`cumany()`](https://dplyr.tidyverse.org/dev/reference/cumall.md) to
...
[`ntile()`](https://dplyr.tidyverse.org/dev/reference/ntile.md). For
