...
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md)
doesn’t really do anything itself; it just changes how the other verbs
work. For example, compare the results of
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md) in the
following code:
...
If you use
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md) with a
regular data frame, it computes the mean of `x`, `y`, and `z` across all
rows. If you apply it to a row-wise data frame, it computes the mean for
each row.
...
so they behave somewhat similarly to the grouping variables passed to
[`group_by()`](https://dplyr.tidyverse.org/dev/reference/group_by.md):
...
just a special form of grouping, so if you want to remove it from a data
frame, just call
...
When combined with
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md) it
also makes it easy to summarise values across columns within one row. To
...
We can then use
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md) to add
a new column to each row, or
[`summarise()`](https://dplyr.tidyverse.org/dev/reference/summarise.md)
...
The [`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md)
...
[`pick()`](https://dplyr.tidyverse.org/dev/reference/pick.md) (not
[`c_across()`](https://dplyr.tidyverse.org/dev/reference/c_across.md))
here because [`rowMeans()`](https://rdrr.io/r/base/colSums.html) and
...
in [`pick()`](https://dplyr.tidyverse.org/dev/reference/pick.md). This
...
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md) slices
up the columns to pass to `length(y)` the grouped mutate uses `[` and
the row-wise mutate uses `[[`. The following code gives a flavour of the
...
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md);
this is important because it’s going to make working with that list of
data frames much easier.
...
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md)
doesn’t just work with functions that return a length-1 vector (aka
summary functions); it can work with any function if the result is a
list. This means that
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md) and
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md)
provide an elegant way to call a function many times with varying
arguments, storing the outputs alongside the inputs.
...
values and a
[`mutate()`](https://dplyr.tidyverse.org/dev/reference/mutate.md)
expression has to return something of length 1.
...
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md) was
...
[`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md)
because I felt like automatically switching between `[` to `[[` was too
magical in the same way that automatically
[`list()`](https://rdrr.io/r/base/list.html)-ing results made
[`do()`](https://dplyr.tidyverse.org/dev/reference/do.md) too magical.
I’ve now persuaded myself that the row-wise magic is good magic partly
because most people find the distinction between `[` and `[[` mystifying
and [`rowwise()`](https://dplyr.tidyverse.org/dev/reference/rowwise.md)
...
[`do()`](https://dplyr.tidyverse.org/dev/reference/do.md) for quite some
...
- Without argument names: you could call functions that input and output
  ...
  [`pick()`](https://dplyr.tidyverse.org/dev/reference/pick.md) plus
  [`reframe()`](https://dplyr.tidyverse.org/dev/reference/reframe.md), a
  variant of
  [`summarise()`](https://dplyr.tidyverse.org/dev/reference/summarise.md)
...
The addition of
[`pick()`](https://dplyr.tidyverse.org/dev/reference/pick.md)/[`across()`](https://dplyr.tidyverse.org/dev/reference/across.md)
and the increased scope of
[`summarise()`](https://dplyr.tidyverse.org/dev/reference/summarise.md)/[`reframe()`](https://dplyr.tidyverse.org/dev/reference/reframe.md)
means that [`do()`](https://dplyr.tidyverse.org/dev/reference/do.md) is
no longer needed, so it is now superseded.
