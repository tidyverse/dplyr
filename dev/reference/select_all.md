...
The matching select statements have been superseded by the combination
of a [`select()`](https://dplyr.tidyverse.org/dev/reference/select.md) +
[`rename_with()`](https://dplyr.tidyverse.org/dev/reference/rename.md).
Any predicate functions passed as arguments to
...
and friends were superseded by
