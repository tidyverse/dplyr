...
[`ungroup()`](https://dplyr.tidyverse.org/dev/reference/group_by.md) or
...
extract a groups worth of data with `[`. But when you index a list in
this way, you get back another list. When you're working with a
`rowwise` tibble, then dplyr will use `[[` instead of `[` to make your
life a little easier.

## See also

[`nest_by()`](https://dplyr.tidyverse.org/dev/reference/nest_by.md) for
a convenient way of creating rowwise data frames with nested data.
