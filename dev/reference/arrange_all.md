...
variants of
[`arrange()`](https://dplyr.tidyverse.org/dev/reference/arrange.md) sort
a data frame by a selection of variables. Like
[`arrange()`](https://dplyr.tidyverse.org/dev/reference/arrange.md), you
can modify the variables before ordering with the `.funs` argument.
