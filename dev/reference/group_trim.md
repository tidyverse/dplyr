...
[`filter()`](https://dplyr.tidyverse.org/dev/reference/filter.md) that
is intended to select a subset of groups.
...
- .tbl:
  ...
  A [grouped data
  frame](https://dplyr.tidyverse.org/dev/reference/grouped_df.md)
