...
is too limited, in terms of what you need to do and return for each
group. `group_modify()` is good for "data frame in, data frame out". If
that is too limited, you need to use a
[nested](https://dplyr.tidyverse.org/dev/reference/group_nest.md) or
[split](https://dplyr.tidyverse.org/dev/reference/group_split.md)
workflow. `group_modify()` is an evolution of
[`do()`](https://dplyr.tidyverse.org/dev/reference/do.md), if you have
used that before.
