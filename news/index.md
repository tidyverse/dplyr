...
- New [`filter_out()`](https://dplyr.tidyverse.org/reference/filter.md)
  companion to
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md).

  - Use [`filter()`](https://dplyr.tidyverse.org/reference/filter.md)
  ...
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) to drop
  rows. It is particularly useful when missing values are involved. For
  example, to drop rows where the `count` is zero:
  ...
  With [`filter()`](https://dplyr.tidyverse.org/reference/filter.md),
  you must provide a “negative” condition of `!= 0` and must explicitly
  guard against accidentally dropping rows with `NA`. With
  [`filter_out()`](https://dplyr.tidyverse.org/reference/filter.md), you
  directly specify rows to drop and you don’t have to guard against
...
- New
  ...
  [`filter_out()`](https://dplyr.tidyverse.org/reference/filter.md) to
...
- [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)
  ...
  [`replace_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md)
  have the familiar
  [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)-style
  ...
  and [`recode()`](https://dplyr.tidyverse.org/reference/recode.md).
...
- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md),
  [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md),
  and [`coalesce()`](https://dplyr.tidyverse.org/reference/coalesce.md)
...
- [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) has
...
- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) no
...
- The `dplyr.legacy_locale` global option is soft-deprecated. If you
  ...
  [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md), use
  `arrange(.locale =)` instead. If you used this to affect the ordering
  of `group_by() |> summarise()`, follow up with an additional call to
  `arrange(.locale =)` instead
  ([\#7760](https://github.com/tidyverse/dplyr/issues/7760)).

- Passing `size` to
  [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) is now
  deprecated. The output size is always taken from the `condition`
...
- The following were already deprecated, and are now defunct and throw
  ...
  - All underscored standard evaluation versions of major dplyr verbs.
    ...
    - [`add_count_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`add_tally_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`arrange_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`count_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`distinct_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`do_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`filter_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`funs_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`group_by_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`group_indices_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`mutate_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`tally_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`transmute_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`rename_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`select_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`slice_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`summarise_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
    - [`summarize_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)

  - [`mutate_each()`](https://dplyr.tidyverse.org/reference/defunct-each.md),
    [`mutate_each_()`](https://dplyr.tidyverse.org/reference/defunct-each.md),
    [`summarise_each()`](https://dplyr.tidyverse.org/reference/defunct-each.md),
    and
    [`summarise_each_()`](https://dplyr.tidyverse.org/reference/defunct-each.md).
  ...
  - [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md).
    Deprecated in 1.0.0 (May 2020), use
    [`c()`](https://rdrr.io/r/base/c.html) or
    [`vctrs::vec_c()`](https://vctrs.r-lib.org/reference/vec_c.html)
    instead.

  - [`src_mysql()`](https://dplyr.tidyverse.org/reference/defunct.md),
    [`src_postgres()`](https://dplyr.tidyverse.org/reference/defunct.md),
    [`src_sqlite()`](https://dplyr.tidyverse.org/reference/defunct.md),
    [`src_local()`](https://dplyr.tidyverse.org/reference/defunct.md),
    and [`src_df()`](https://dplyr.tidyverse.org/reference/defunct.md).
    Deprecated in 1.0.0 (May 2020), use
    [`tbl()`](https://dplyr.tidyverse.org/reference/tbl.md) instead.

  - [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md) and
    [`as.tbl()`](https://dplyr.tidyverse.org/reference/defunct.md).
    Deprecated in 1.0.0 (May 2020), use
    [`tibble::as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.html)
    instead.

  - [`add_rownames()`](https://dplyr.tidyverse.org/reference/defunct.md).
    Deprecated in 1.0.0 (May 2020), use
  ...
  - The `add` argument of
    ...
    and
    [`group_by_prepare()`](https://dplyr.tidyverse.org/reference/group_by_prepare.md).
  ...
  - The `...` argument of
    ...
    and
    [`group_indices()`](https://dplyr.tidyverse.org/reference/group_data.md).
    Deprecated in 1.0.0 (May 2020), use
    [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
    first.
  ...
  - Using [`across()`](https://dplyr.tidyverse.org/reference/across.md)
    and data frames in
    [`filter()`](https://dplyr.tidyverse.org/reference/filter.md).
    Deprecated in 1.0.8 (Feb 2022), use
    [`if_any()`](https://dplyr.tidyverse.org/reference/across.md) or
    [`if_all()`](https://dplyr.tidyverse.org/reference/across.md)
    instead.
...
- The following were already deprecated, and now warn unconditionally if
  ...
  - [`all_equal()`](https://dplyr.tidyverse.org/reference/all_equal.md).
    Deprecated in 1.1.0 (Jan 2023), use
    [`all.equal()`](https://rdrr.io/r/base/all.equal.html) instead.

  - [`progress_estimated()`](https://dplyr.tidyverse.org/reference/progress_estimated.md).
    Deprecated in 1.0.0 (May 2020).

  - [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) with a
    1 column matrix. Deprecated in 1.1.0 (Jan 2023), use a vector
    instead.

  - [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) with a 1
    column matrix. Deprecated in 1.1.0 (Jan 2023), use a vector instead.
...
- The following were already soft-deprecated, and now warn once per
  ...
  - [`cur_data()`](https://dplyr.tidyverse.org/reference/deprec-context.md)
    and
    [`cur_data_all()`](https://dplyr.tidyverse.org/reference/deprec-context.md).
    Deprecated in 1.1.0 (Jan 2023), use
...
- The superseded
  [`recode()`](https://dplyr.tidyverse.org/reference/recode.md) now has
  updated documentation showing how to migrate to
  [`recode_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md)
  and
  [`replace_values()`](https://dplyr.tidyverse.org/reference/recode-and-replace-values.md).

- The `.groups` message emitted by
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) is
...
- [`if_any()`](https://dplyr.tidyverse.org/reference/across.md) and
  [`if_all()`](https://dplyr.tidyverse.org/reference/across.md) are now
  more consistent in all use cases
...
- Empty [`rowwise()`](https://dplyr.tidyverse.org/reference/rowwise.md)
...
- [`last_dplyr_warnings()`](https://dplyr.tidyverse.org/reference/last_dplyr_warnings.md)
...
- New [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.md)
...
- Updated [`across()`](https://dplyr.tidyverse.org/reference/across.md)
...
- Clarified how
  [`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md) and
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md) work
...
- [`join_by()`](https://dplyr.tidyverse.org/reference/join_by.md) now
  allows its helper functions to be namespaced with `dplyr::`, like
...
- [`dplyr_reconstruct()`](https://dplyr.tidyverse.org/reference/dplyr_extending.md)’s
...
- [`setequal()`](https://dplyr.tidyverse.org/reference/setops.md) now
  requires the input data frames to be compatible, similar to the other
  set methods like
  [`setdiff()`](https://dplyr.tidyverse.org/reference/setops.md) or
...
- [`count()`](https://dplyr.tidyverse.org/reference/count.md) better
...
- Fixed a performance regression related to
  ...
  [`first()`](https://dplyr.tidyverse.org/reference/nth.md), and
...
- [`n()`](https://dplyr.tidyverse.org/reference/context.md) is a little
  faster when there are many groups
  ([\#6727](https://github.com/tidyverse/dplyr/issues/6727)).

- [`pick()`](https://dplyr.tidyverse.org/reference/pick.md) now returns
  a 1 row, 0 column tibble when `...` evaluates to an empty selection.
  This makes it more compatible with [tidyverse recycling
  rules](https://vctrs.r-lib.org/reference/theory-faq-recycling.html) in
  some edge cases
  ([\#6685](https://github.com/tidyverse/dplyr/issues/6685)).

- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) and
  [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md)
  again accept logical conditions that have attributes
  ([\#6678](https://github.com/tidyverse/dplyr/issues/6678)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) can
  once again sort the `numeric_version` type from base R
  ([\#6680](https://github.com/tidyverse/dplyr/issues/6680)).

- [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.md) now
  works when the input has a column named `replace`.
  [`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md) and
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md) now
  work when the input has columns named `na_rm` or `with_ties`
  ([\#6725](https://github.com/tidyverse/dplyr/issues/6725)).

- [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) now errors
...
- Deprecation warnings thrown by
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) now
...
- The compatibility vignette has been replaced with a more general
  ...
  [`vignette("in-packages")`](https://dplyr.tidyverse.org/articles/in-packages.md)
...
- [`rename_with()`](https://dplyr.tidyverse.org/reference/rename.md) now
  includes an example of using `paste0(recycle0 = TRUE)` to correctly
...
- [`.by`/`by`](https://dplyr.tidyverse.org/reference/dplyr_by.html) is
  ...
  [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) that
  supports per-operation grouping for
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md),
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md),
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md), and the
  [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) family
  ([\#6528](https://github.com/tidyverse/dplyr/issues/6528)).
  ...
  previous call to
  [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md), and
...
- [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) is a
  new experimental verb that creates a new data frame by applying
  functions to columns of an existing data frame. It is very similar to
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md),
  with two big differences:

  - [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) can
    return an arbitrary number of rows per group, while
    [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
  ...
  [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) has
  been added in response to valid concern from the community that
  allowing
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) to
  return any number of rows per group increases the chance for
  accidental bugs. We still feel that this is a powerful technique, and
  is a principled replacement for
  [`do()`](https://dplyr.tidyverse.org/reference/do.md), so we have
  moved these features to
  [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md)
  ([\#6382](https://github.com/tidyverse/dplyr/issues/6382)).

- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) now
  uses a new algorithm for computing groups. It is often faster than the
  previous approach (especially when there are many groups), and in most
  cases there should be no changes. The one exception is with character
  vectors, see the C locale news bullet below for more details
  ([\#4406](https://github.com/tidyverse/dplyr/issues/4406),
  [\#6297](https://github.com/tidyverse/dplyr/issues/6297)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) now
  uses a faster algorithm for sorting character vectors, which is
...
- Joins have been completely overhauled to enable more flexible join
  ...
  - Join specifications allow for new types of joins:
    ...
    - Overlap joins: For detecting overlaps between sets of columns,
      ...
      [`between()`](https://dplyr.tidyverse.org/reference/between.md),
      [`within()`](https://dplyr.tidyverse.org/reference/join_by.md), or
    ...
    Instead, use
    [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) to
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md) gains an
  experimental `.unpack` argument to optionally unpack (as in,
...
- [`pick()`](https://dplyr.tidyverse.org/reference/pick.md) makes it
  easy to access a subset of columns from the current group.
  [`pick()`](https://dplyr.tidyverse.org/reference/pick.md) is intended
  as a replacement for `across(.fns = NULL)`,
  [`cur_data()`](https://dplyr.tidyverse.org/reference/deprec-context.md),
  and
  [`cur_data_all()`](https://dplyr.tidyverse.org/reference/deprec-context.md).
  We feel that [`pick()`](https://dplyr.tidyverse.org/reference/pick.md)
  is a much more evocative name when you are just trying to select a
  subset of columns from your data
  ([\#6204](https://github.com/tidyverse/dplyr/issues/6204)).

- [`symdiff()`](https://dplyr.tidyverse.org/reference/setops.md)
...
- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) and
  [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) now
  use the C locale, not the system locale, when ordering or grouping
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md),
  ...
  [`if_any()`](https://dplyr.tidyverse.org/reference/across.md), and
  [`if_all()`](https://dplyr.tidyverse.org/reference/across.md) now
  require the `.cols` and `.fns` arguments. In general, we now recommend
  that you use [`pick()`](https://dplyr.tidyverse.org/reference/pick.md)
  instead of an empty
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) call or
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) with no
  `.fns` (e.g. `across(c(x, y))`.
...
- Passing `...` to
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) is
...
- [`all_equal()`](https://dplyr.tidyverse.org/reference/all_equal.md) is
  deprecated. We’ve advised against it for some time, and we explicitly
  recommend you use
...
- [`cur_data()`](https://dplyr.tidyverse.org/reference/deprec-context.md)
  ...
  [`pick()`](https://dplyr.tidyverse.org/reference/pick.md)
  ([\#6204](https://github.com/tidyverse/dplyr/issues/6204)).
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md)ing with
  a 1-column matrix is deprecated
...
- Using
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) to
  produce a 0 or \>1 row “summary” is deprecated in favor of the new
  [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md). See
  the NEWS bullet about
  [`reframe()`](https://dplyr.tidyverse.org/reference/reframe.md) for
  more details
  ([\#6382](https://github.com/tidyverse/dplyr/issues/6382)).
...
- All functions deprecated in 1.0.0 (released April 2020) and earlier
  ...
  [`mutate_each_()`](https://dplyr.tidyverse.org/reference/defunct-each.md),
  [`as.tbl()`](https://dplyr.tidyverse.org/reference/defunct.md),
  [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md), and a
  handful of older arguments. They are likely to be made defunct in the
  next major version (but not before mid 2024).

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md)ing with a
  1-column matrix is deprecated.

#### Newly superseded

- [`recode()`](https://dplyr.tidyverse.org/reference/recode.md) is
...
- [`transmute()`](https://dplyr.tidyverse.org/reference/transmute.md) is
  superseded in favour of `mutate(.keep = "none")`
  ([\#6414](https://github.com/tidyverse/dplyr/issues/6414)).

#### Newly stable

- The `.keep`, `.before`, and `.after` arguments to
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) have
  moved from experimental to stable.
...
- [`between()`](https://dplyr.tidyverse.org/reference/between.md) can
  now work with all vector types, not just numeric and date-time.
...
- [`first()`](https://dplyr.tidyverse.org/reference/nth.md),
  [`last()`](https://dplyr.tidyverse.org/reference/nth.md), and
  [`nth()`](https://dplyr.tidyverse.org/reference/nth.md)
...
- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) gains
  most of the same benefits as
  [`case_when()`](https://dplyr.tidyverse.org/reference/case-and-replace-when.md).
  In particular,
  [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) now
  takes the common type of `true`, `false`, and `missing` to determine
  the output type, meaning that you can now reliably use `NA`, rather
  than `NA_character_` and friends
  ([\#6243](https://github.com/tidyverse/dplyr/issues/6243)).

  [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) also
  no longer allows you to supply `NULL` for either `true` or `false`,
  which was an undocumented usage that we consider to be off-label,
  because `true` and `false` are intended to be (and documented to be)
  vector inputs
...
- [`na_if()`](https://dplyr.tidyverse.org/reference/na_if.md)
  ...
  [`na_if()`](https://dplyr.tidyverse.org/reference/na_if.md) was never
  intended to work this way, and this is considered off-label usage.

  You can also now replace `NaN` values in `x` with `na_if(x, NaN)`.

- [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and
  [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md) now cast
  `default` to the type of `x`, rather than taking the common type. This
  ensures that these functions are type stable on `x`
...
- Warnings are enriched with contextualised information in
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
  and [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) just
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md) used
...
- Anonymous functions supplied with `function()` and `\()` are now
  inlined by
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) if
  possible, which slightly improves performance and makes possible
  further optimisations in the future.

- Functions supplied to
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) are no
  longer masked by columns
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md) will now
  error when supplied `...` without a `.fns` argument
  ([\#6638](https://github.com/tidyverse/dplyr/issues/6638)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) now
  correctly ignores `NULL` inputs
  ([\#6193](https://github.com/tidyverse/dplyr/issues/6193)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) now
  works correctly when
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) calls
  are used as the 2nd (or more) ordering expression
  ([\#6495](https://github.com/tidyverse/dplyr/issues/6495)).

- `arrange(df, mydesc::desc(x))` works correctly when mydesc re-exports
  [`dplyr::desc()`](https://dplyr.tidyverse.org/reference/desc.md)
  ([\#6231](https://github.com/tidyverse/dplyr/issues/6231)).

- [`c_across()`](https://dplyr.tidyverse.org/reference/c_across.md) now
  evaluates
...
- [`c_across()`](https://dplyr.tidyverse.org/reference/c_across.md) now
  throws a more informative error if you try to rename during column
...
- dplyr no longer provides
  ...
  [`tally()`](https://dplyr.tidyverse.org/reference/count.md) methods
  for `tbl_sql`. These methods have been accidentally overriding the
  `tbl_lazy` methods that dbplyr provides, which has resulted in issues
  with the grouping structure of the output
  ([\#6338](https://github.com/tidyverse/dplyr/issues/6338),
  tidyverse/dbplyr#940).

- [`cur_group()`](https://dplyr.tidyverse.org/reference/context.md) now
  works correctly with zero row grouped data frames
  ([\#6304](https://github.com/tidyverse/dplyr/issues/6304)).

- [`desc()`](https://dplyr.tidyverse.org/reference/desc.md) gives a
  useful error message if you give it a non-vector
  ([\#6028](https://github.com/tidyverse/dplyr/issues/6028)).

- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) now
  retains attributes of bare data frames
...
- Error messages in
  [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md),
  [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md),
  [`tally()`](https://dplyr.tidyverse.org/reference/count.md), and
  [`count()`](https://dplyr.tidyverse.org/reference/count.md) are now
  more relevant
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) behaves
  a little better with 0-row rowwise inputs
  ([\#6303](https://github.com/tidyverse/dplyr/issues/6303)).

- A rowwise
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) now
...
- [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) now
  requires `n` to be a single positive integer.

- [`relocate()`](https://dplyr.tidyverse.org/reference/relocate.md) now
  works correctly with empty data frames and when `.before` or `.after`
  result in empty selections
  ([\#6167](https://github.com/tidyverse/dplyr/issues/6167)).

- [`relocate()`](https://dplyr.tidyverse.org/reference/relocate.md) no
  longer drops attributes of bare data frames
  ([\#6341](https://github.com/tidyverse/dplyr/issues/6341)).

- [`relocate()`](https://dplyr.tidyverse.org/reference/relocate.md) now
  retains the last name change when a single column is renamed multiple
  times while it is being moved. This better matches the behavior of
...
- [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) now
...
- [`rename_with()`](https://dplyr.tidyverse.org/reference/rename.md) now
  disallows renaming in the `.cols` tidy-selection
  ([\#6561](https://github.com/tidyverse/dplyr/issues/6561)).

- [`rename_with()`](https://dplyr.tidyverse.org/reference/rename.md) now
  checks that the result of `.fn` is the right type and size
  ([\#6561](https://github.com/tidyverse/dplyr/issues/6561)).

- [`rows_insert()`](https://dplyr.tidyverse.org/reference/rows.md) now
  checks that `y` contains the `by` columns
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) helpers
  again produce output equivalent to `slice(.data, 0)` when the `n` or
  `prop` argument is 0, fixing a bug introduced in the previous version
  ([@eutwt](https://github.com/eutwt),
  [\#6184](https://github.com/tidyverse/dplyr/issues/6184)).

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) with no
  inputs now returns 0 rows. This is mostly for theoretical consistency
  ([\#6573](https://github.com/tidyverse/dplyr/issues/6573)).

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) now errors
  if any expressions in `...` are named. This helps avoid accidentally
  misspelling an optional argument, such as `.by`
...
- [`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md) and
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md) can
  `order_by` multiple variables if you supply them as a data.frame or
  tibble ([\#6176](https://github.com/tidyverse/dplyr/issues/6176)).

- [`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md) and
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md) now
  consistently include missing values in the result if necessary
...
- [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.md) now
  accepts negative `n` and `prop` values
...
- [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.md) now
  gives a more informative error when `replace = FALSE` and the number
  of rows requested in the sample exceeds the number of rows in the data
  ([\#6271](https://github.com/tidyverse/dplyr/issues/6271)).
...
- [`union_all()`](https://dplyr.tidyverse.org/reference/setops.md), like
  [`union()`](https://dplyr.tidyverse.org/reference/setops.md), now
  requires that data frames be compatible: i.e. they have the same
...
- New [`rows_append()`](https://dplyr.tidyverse.org/reference/rows.md)
  which works like
  [`rows_insert()`](https://dplyr.tidyverse.org/reference/rows.md) but
  ignores keys and allows you to insert arbitrary rows with a guarantee
  that the type of `x` won’t change
...
- The `rows_*()` functions no longer require that the key values in `x`
  ...
  [`rows_insert()`](https://dplyr.tidyverse.org/reference/rows.md) and
  [`rows_delete()`](https://dplyr.tidyverse.org/reference/rows.md) no
  longer require that the key values in `y` uniquely identify each row.
  Relaxing this restriction should make these functions more practically
  useful for data frames, and alternative backends can enforce this in
  other ways as needed (i.e. through primary keys)
...
- [`rows_update()`](https://dplyr.tidyverse.org/reference/rows.md),
  [`rows_patch()`](https://dplyr.tidyverse.org/reference/rows.md), and
...
- [`rows_delete()`](https://dplyr.tidyverse.org/reference/rows.md) no
  longer requires that the columns of `y` be a strict subset of `x`.
...
- `mutate(.keep = "none")` is no longer identical to
  [`transmute()`](https://dplyr.tidyverse.org/reference/transmute.md).
  [`transmute()`](https://dplyr.tidyverse.org/reference/transmute.md)
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) forbids
  matrix results
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) helpers
  ...
  [`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md)) now
  accept negative values for `n` and `prop`
  ([\#5961](https://github.com/tidyverse/dplyr/issues/5961)).

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) now
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md) uses the
  formula environment when inlining them
...
- [`c_across()`](https://dplyr.tidyverse.org/reference/c_across.md) and
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) key
  deparsing not confused by long calls
  ([\#5883](https://github.com/tidyverse/dplyr/issues/5883)).

- [`across()`](https://dplyr.tidyverse.org/reference/across.md) handles
  named selections
...
- [`add_count()`](https://dplyr.tidyverse.org/reference/count.md) is now
  generic ([\#5837](https://github.com/tidyverse/dplyr/issues/5837)).

- [`if_any()`](https://dplyr.tidyverse.org/reference/across.md) and
  [`if_all()`](https://dplyr.tidyverse.org/reference/across.md) abort
  when a predicate is mistakingly used as `.cols=`
  ([\#5732](https://github.com/tidyverse/dplyr/issues/5732)).

- Multiple calls to
  [`if_any()`](https://dplyr.tidyverse.org/reference/across.md) and/or
  [`if_all()`](https://dplyr.tidyverse.org/reference/across.md) in the
  same expression are now properly disambiguated
  ([\#5782](https://github.com/tidyverse/dplyr/issues/5782)).

- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) now
  inlines [`if_any()`](https://dplyr.tidyverse.org/reference/across.md)
  and [`if_all()`](https://dplyr.tidyverse.org/reference/across.md)
  expressions. This greatly improves performance with grouped data
  frames.

- Fixed behaviour of `...` in top-level
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) calls
  ([\#5813](https://github.com/tidyverse/dplyr/issues/5813),
  [\#5832](https://github.com/tidyverse/dplyr/issues/5832)).

- [`across()`](https://dplyr.tidyverse.org/reference/across.md) now
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) no
...
- Fixed quosure handling in
  [`dplyr::group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
...
- [`across()`](https://dplyr.tidyverse.org/reference/across.md) can
...
- The `.cols=` argument of
  [`if_any()`](https://dplyr.tidyverse.org/reference/across.md) and
  [`if_all()`](https://dplyr.tidyverse.org/reference/across.md) defaults
  to
  [`everything()`](https://tidyselect.r-lib.org/reference/everything.html).
...
- Improved performance for
  [`across()`](https://dplyr.tidyverse.org/reference/across.md). This
  makes `summarise(across())` and `mutate(across())` perform as well as
  the superseded colwise equivalents
...
- Fixed a performance regression in
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) when
  ...
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) is
  called within
...
- [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) no
  longer informs when the result is ungrouped
...
- [`count()`](https://dplyr.tidyverse.org/reference/count.md) and
  [`tally()`](https://dplyr.tidyverse.org/reference/count.md) are now
  generic.
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) uses
  the ungrouped data for the implicit mutate step
...
- [`relocate()`](https://dplyr.tidyverse.org/reference/relocate.md) can
  rename columns it relocates
  ([\#5569](https://github.com/tidyverse/dplyr/issues/5569)).

- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) and
  [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) have
  better error messages when the mutate step fails
  ([\#5060](https://github.com/tidyverse/dplyr/issues/5060)).

- Clarify that
  [`between()`](https://dplyr.tidyverse.org/reference/between.md) is not
  vectorised ([\#5493](https://github.com/tidyverse/dplyr/issues/5493)).

- Fixed [`across()`](https://dplyr.tidyverse.org/reference/across.md)
  ...
  the nested case
  ([`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) within
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md))
  ([\#5498](https://github.com/tidyverse/dplyr/issues/5498)).

- [`across()`](https://dplyr.tidyverse.org/reference/across.md) handles
  data frames with 0 columns
  ([\#5523](https://github.com/tidyverse/dplyr/issues/5523)).

- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) always
  keeps grouping variables, unconditional to `.keep=`
...
- [`count()`](https://dplyr.tidyverse.org/reference/count.md) and
  [`tally()`](https://dplyr.tidyverse.org/reference/count.md) no longer
  automatically weights by column `n` if present
  ...
  [`count()`](https://dplyr.tidyverse.org/reference/count.md) did not,
  but this behaviour was accidentally changed in 0.8.2
...
- [`coalesce()`](https://dplyr.tidyverse.org/reference/coalesce.md) now
  supports data frames correctly
  ([\#5326](https://github.com/tidyverse/dplyr/issues/5326)).

- [`cummean()`](https://dplyr.tidyverse.org/reference/cumall.md) no
...
- [`bind_cols()`](https://dplyr.tidyverse.org/reference/bind_cols.md) no
  longer converts to a tibble, returns a data frame if the input is a
  data frame.

- [`bind_rows()`](https://dplyr.tidyverse.org/reference/bind_rows.md),
  `*_join()`,
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
  and [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) use
  vctrs coercion rules. There are two main user facing changes:
...
- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) on
  missing columns now raises an error, it has been a compatibility
...
- [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) are
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) and
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) use the
  latest version of the tidyselect interface. Practically, this means
  that you can now combine selections using Boolean logic (i.e. `!`, `&`
  and `|`), and use predicate functions with
  ...
  [`select()`](https://dplyr.tidyverse.org/reference/select.md) and
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) to
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) gains a
  new set of helpers:

  - [`slice_head()`](https://dplyr.tidyverse.org/reference/slice.md) and
    [`slice_tail()`](https://dplyr.tidyverse.org/reference/slice.md)
...
- New [`relocate()`](https://dplyr.tidyverse.org/reference/relocate.md)
...
- [`ungroup()`](https://dplyr.tidyverse.org/reference/group_by.md) can
  now selectively remove grouping variables
  ([\#3760](https://github.com/tidyverse/dplyr/issues/3760)).

- [`pull()`](https://dplyr.tidyverse.org/reference/pull.md) can now
...
- New function
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) that can
  be used inside
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md),
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md), and
...
- New function
  [`c_across()`](https://dplyr.tidyverse.org/reference/c_across.md) that
  can be used inside
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
  and [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) in
  row-wise data frames to easily (e.g.) compute a row-wise mean of all
...
- [`rowwise()`](https://dplyr.tidyverse.org/reference/rowwise.md) is no
  longer questioning; we now understand that it’s an important tool when
  you don’t have vectorised code. It now also allows you to specify
  ...
  or [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md).

- New, experimental,
  [`nest_by()`](https://dplyr.tidyverse.org/reference/nest_by.md). It
  has the same interface as
  [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md), but
  returns a rowwise data frame of grouping keys, supplemental with a
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) uses
  hashing from the `vctrs` package.
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) does
  not create an arbitrary NA group when grouping by factors with
  `drop = TRUE`
...
- In [`add_count()`](https://dplyr.tidyverse.org/reference/count.md),
...
- [`as.tbl()`](https://dplyr.tidyverse.org/reference/defunct.md) and
  [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md): please
  use
  [`as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.html)
  instead.
...
- [`funs()`](https://dplyr.tidyverse.org/reference/funs.md): please use
...
- [`src_local()`](https://dplyr.tidyverse.org/reference/defunct.md) has
  been deprecated; it was part of an approach to testing dplyr backends
  that didn’t pan out.

- [`src_mysql()`](https://dplyr.tidyverse.org/reference/defunct.md),
  [`src_postgres()`](https://dplyr.tidyverse.org/reference/defunct.md),
  and [`src_sqlite()`](https://dplyr.tidyverse.org/reference/defunct.md)
...
- The scoped helpers (all functions ending in `_if`, `_at`, or `_all`)
  ...
  [`across()`](https://dplyr.tidyverse.org/reference/across.md). This
  dramatically reduces the API surface for dplyr, while at the same
...
- [`do()`](https://dplyr.tidyverse.org/reference/do.md) is superseded in
  favour of
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md).

- [`sample_n()`](https://dplyr.tidyverse.org/reference/sample_n.md) and
  [`sample_frac()`](https://dplyr.tidyverse.org/reference/sample_n.md)
  have been superseded by
  [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.md).
  See [`?sample_n`](https://dplyr.tidyverse.org/reference/sample_n.md)
  for details about why, and for examples converting from old to new
  usage.

- [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) has been
  superseded
  by[`slice_min()`](https://dplyr.tidyverse.org/reference/slice.md)/[`slice_max()`](https://dplyr.tidyverse.org/reference/slice.md).
  See [`?top_n`](https://dplyr.tidyverse.org/reference/top_n.md) for
...
- [`all_equal()`](https://dplyr.tidyverse.org/reference/all_equal.md) is
  questioning; it solves a problem that no longer seems important.
...
- New [`vignette("base")`](https://dplyr.tidyverse.org/articles/base.md)
...
- New
  [`vignette("grouping")`](https://dplyr.tidyverse.org/articles/grouping.md)
...
- [`coalesce()`](https://dplyr.tidyverse.org/reference/coalesce.md) now
  uses vctrs recycling and common type coercion rules
  ([\#5186](https://github.com/tidyverse/dplyr/issues/5186)).

- [`count()`](https://dplyr.tidyverse.org/reference/count.md) and
  [`add_count()`](https://dplyr.tidyverse.org/reference/count.md) do a
  better job of preserving input class and attributes
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) handles
  data frame results when all columns are logical vectors by reducing
  them with `&`
  ([\#4678](https://github.com/tidyverse/dplyr/issues/4678)). In
  particular this means
  [`across()`](https://dplyr.tidyverse.org/reference/across.md) can be
  used in [`filter()`](https://dplyr.tidyverse.org/reference/filter.md).
...
- [`groups()`](https://dplyr.tidyverse.org/reference/group_data.md) now
  returns [`list()`](https://rdrr.io/r/base/list.html) for ungrouped
...
- `group_keys.rowwise_df()` gives a 0 column data frame with
  [`n()`](https://dplyr.tidyverse.org/reference/context.md) rows.

- [`group_map()`](https://dplyr.tidyverse.org/reference/group_map.md) is
  now a generic
...
- [`src_tbls()`](https://dplyr.tidyverse.org/reference/src_tbls.md)
  accepts `...` arguments
...
- [`rename_at()`](https://dplyr.tidyverse.org/reference/select_all.md)
  and
  [`rename_all()`](https://dplyr.tidyverse.org/reference/select_all.md)
  call the function with a simple character vector, not a
  `dplyr_sel_vars`
  ([\#4459](https://github.com/tidyverse/dplyr/issues/4459)).

- [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) is now
...
- Updated
  [`distinct_if()`](https://dplyr.tidyverse.org/reference/distinct_all.md),
  [`distinct_at()`](https://dplyr.tidyverse.org/reference/distinct_all.md)
  and
  [`distinct_all()`](https://dplyr.tidyverse.org/reference/distinct_all.md)
...
- [`first()`](https://dplyr.tidyverse.org/reference/nth.md),
  [`last()`](https://dplyr.tidyverse.org/reference/nth.md) and
  [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) hybrid version
  handles factors
  ([\#4295](https://github.com/tidyverse/dplyr/issues/4295)).

### Minor changes

- [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) quotes its
  `n` argument, `n` no longer needs to be constant for all groups
  ([\#4017](https://github.com/tidyverse/dplyr/issues/4017)).

- [`tbl_vars()`](https://dplyr.tidyverse.org/reference/tbl_vars.md)
...
- [`select.list()`](https://rdrr.io/r/utils/select.list.html) method
  added so that
  [`select()`](https://dplyr.tidyverse.org/reference/select.md) does not
  dispatch on lists
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) puts
  NA groups last in character vectors
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) does
  a shallow copy even in the no groups case
  ([\#4221](https://github.com/tidyverse/dplyr/issues/4221)).

- Fixed [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) on
...
- [`select_if()`](https://dplyr.tidyverse.org/reference/select_all.md)
  and
  [`rename_if()`](https://dplyr.tidyverse.org/reference/select_all.md)
...
- The error `could not find function "n"` or the warning
  ...
  [`dplyr::n()`](https://dplyr.tidyverse.org/reference/context.md)
...
- If you see `checking S3 generic/method consistency` in R CMD check for
  ...
  - [`sample_n()`](https://dplyr.tidyverse.org/reference/sample_n.md)
    ...
    have gained `...`
  - [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) and
    [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) have
    gained `.preserve`
  - [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
    has gained `.drop`
...
- [`distinct_prepare()`](https://dplyr.tidyverse.org/reference/group_by_prepare.md),
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) and
  [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) gain a
...
- [`tally()`](https://dplyr.tidyverse.org/reference/count.md) works
  correctly on non-data frame table sources such as `tbl_sql`
  ([\#3075](https://github.com/tidyverse/dplyr/issues/3075)).

- [`sample_n()`](https://dplyr.tidyverse.org/reference/sample_n.md) and
  [`sample_frac()`](https://dplyr.tidyverse.org/reference/sample_n.md)
  can use [`n()`](https://dplyr.tidyverse.org/reference/context.md)
...
- [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md) uses
  tidy dots ([\#3407](https://github.com/tidyverse/dplyr/issues/3407)).
...
- Using
  ...
  [`transmute_all()`](https://dplyr.tidyverse.org/reference/mutate_all.md),
  [`mutate_if()`](https://dplyr.tidyverse.org/reference/mutate_all.md)
  and
  [`transmute_if()`](https://dplyr.tidyverse.org/reference/mutate_all.md)
  ...
  [`transmute_at()`](https://dplyr.tidyverse.org/reference/mutate_all.md)
...
- [`first()`](https://dplyr.tidyverse.org/reference/nth.md) and
  [`last()`](https://dplyr.tidyverse.org/reference/nth.md) hybrid
  functions fall back to R evaluation when given no arguments
  ([\#3589](https://github.com/tidyverse/dplyr/issues/3589)).

- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) removes
  a column when the expression evaluates to `NULL` for all groups
  ([\#2945](https://github.com/tidyverse/dplyr/issues/2945)).

- grouped data frames support `[, drop = TRUE]`
  ([\#3714](https://github.com/tidyverse/dplyr/issues/3714)).

- New low-level constructor
  [`new_grouped_df()`](https://dplyr.tidyverse.org/reference/new_grouped_df.md)
  and validator `validate_grouped_df`
  ([\#3837](https://github.com/tidyverse/dplyr/issues/3837)).

- [`glimpse()`](https://dplyr.tidyverse.org/reference/glimpse.md) prints
  group information on grouped tibbles
...
- [`do()`](https://dplyr.tidyverse.org/reference/do.md),
  [`rowwise()`](https://dplyr.tidyverse.org/reference/rowwise.md) and
  [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md) are
  questioning
  ([\#3494](https://github.com/tidyverse/dplyr/issues/3494)).

- [`funs()`](https://dplyr.tidyverse.org/reference/funs.md) is
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) does
  ...
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) on
...
- The grouping metadata of grouped data frame has been reorganized in a
  ...
  groups. The new
  [`group_rows()`](https://dplyr.tidyverse.org/reference/group_data.md)
...
- Set operations like
  [`intersect()`](https://dplyr.tidyverse.org/reference/setops.md) and
...
- [`do()`](https://dplyr.tidyverse.org/reference/do.md) operations with
  more than one named argument can access `.`
...
- Fix [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) and
  [`row_number()`](https://dplyr.tidyverse.org/reference/row_number.md)
...
- [`enexpr()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md),
  [`expr()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md),
  `exprs()`,
  [`sym()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
  and
  [`syms()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
  are now exported.
  [`sym()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
  and
  [`syms()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
  ...
  [`quo()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md),
  [`quos()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
  and
  [`enquo()`](https://dplyr.tidyverse.org/reference/tidyeval-compat.md)
...
- dplyr now depends on the new tidyselect package to power
  [`select()`](https://dplyr.tidyverse.org/reference/select.md),
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md),
  [`pull()`](https://dplyr.tidyverse.org/reference/pull.md) and their
  variants ([\#2896](https://github.com/tidyverse/dplyr/issues/2896)).
  Consequently `select_vars()`, `select_var()` and `rename_vars()` are
  soft-deprecated and will start issuing warnings in a future version.

  Following the switch to tidyselect,
  [`select()`](https://dplyr.tidyverse.org/reference/select.md) and
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) fully
...
- In [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) it is
  now illegal to use `data.frame` in the rhs
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) and
  [`vars()`](https://dplyr.tidyverse.org/reference/vars.md) now treat
  `NULL` as empty inputs
  ([\#3023](https://github.com/tidyverse/dplyr/issues/3023)).

- Scoped select and rename functions
  ([`select_all()`](https://dplyr.tidyverse.org/reference/select_all.md),
  [`rename_if()`](https://dplyr.tidyverse.org/reference/select_all.md)
  ...
  [`group_by_at()`](https://dplyr.tidyverse.org/reference/group_by_all.md)
  can group by an existing grouping variable
  ([\#3351](https://github.com/tidyverse/dplyr/issues/3351)).
  [`arrange_at()`](https://dplyr.tidyverse.org/reference/arrange_all.md)
  can use grouping variables
  ([\#3332](https://github.com/tidyverse/dplyr/issues/3332)).

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) no longer
  enforce tibble classes when input is a simple `data.frame`, and
  ignores 0 ([\#3297](https://github.com/tidyverse/dplyr/issues/3297),
  [\#3313](https://github.com/tidyverse/dplyr/issues/3313)).

- [`transmute()`](https://dplyr.tidyverse.org/reference/transmute.md) no
  longer prints a message when including a group variable.

### Documentation

- Improved documentation for
  [`funs()`](https://dplyr.tidyverse.org/reference/funs.md)
  ([\#3094](https://github.com/tidyverse/dplyr/issues/3094)) and set
  operations
  (e.g. [`union()`](https://dplyr.tidyverse.org/reference/setops.md))
...
- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) fails
  gracefully on `data.frame` columns
...
- Add warning with explanation to
  [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) if
  any of the selected columns are of type `list`
...
- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) now
  throws an error when used on unknown columns
  ([\#2867](https://github.com/tidyverse/dplyr/issues/2867),
  [@foo-bar-baz-qux](https://github.com/foo-bar-baz-qux)).

- Fixed rare out-of-bounds memory write in
  [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) when
  negative indices beyond the number of rows were involved
  ([\#3073](https://github.com/tidyverse/dplyr/issues/3073)).

- [`select()`](https://dplyr.tidyverse.org/reference/select.md),
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) and
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) no
  longer change the grouped vars of the original data
...
- Fix undefined behaviour in
  [`between()`](https://dplyr.tidyverse.org/reference/between.md), where
  `NA_REAL` were assigned instead of `NA_LOGICAL`.
  ([\#2855](https://github.com/tidyverse/dplyr/issues/2855),
  [@zeehio](https://github.com/zeehio))

- [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) now
...
- Reuse of new variables created in ungrouped
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) possible
  again, regression introduced in dplyr 0.7.0
...
- New [`add_count()`](https://dplyr.tidyverse.org/reference/count.md)
  and [`add_tally()`](https://dplyr.tidyverse.org/reference/count.md)
  for adding an `n` column within groups
  ([\#2078](https://github.com/tidyverse/dplyr/issues/2078),
  [@dgrtwo](https://github.com/dgrtwo)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) for
  grouped data frames gains a `.by_group` argument so you can choose to
  sort by groups if you want to (defaults to `FALSE`)
  ([\#2318](https://github.com/tidyverse/dplyr/issues/2318))

- New [`pull()`](https://dplyr.tidyverse.org/reference/pull.md) generic
  for extracting a single column either by name or position (either from
  the left or the right). Thanks to
...
- [`as_tibble()`](https://tibble.tidyverse.org/reference/as_tibble.html)
  ...
  [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md) has
...
dplyr, see
[`wrap_dbplyr_obj()`](https://dplyr.tidyverse.org/reference/check_dbplyr.md)
for helpers.
...
- Fix [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
...
- The scoped verbs taking predicates
  ...
  [`tbl_vars()`](https://dplyr.tidyverse.org/reference/tbl_vars.md). For
  lazy tables, the first 100 rows are collected and the predicate is
...
- [`funs()`](https://dplyr.tidyverse.org/reference/funs.md) has better
  handling of namespaced functions
...
- [`common_by()`](https://dplyr.tidyverse.org/reference/common_by.md)
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) (and the
  internal function `select_vars()`) now support column names in
...
- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) no
  longer duplicates variables
  ([\#2001](https://github.com/tidyverse/dplyr/issues/2001)).

- Empty
  [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) with
  a grouped data frame works the same way as an empty
  [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) on
  an ungrouped data frame, namely it uses all variables
  ([\#2476](https://github.com/tidyverse/dplyr/issues/2476)).

- [`copy_to()`](https://dplyr.tidyverse.org/reference/copy_to.md) now
  returns its output invisibly (since you’re often just calling for the
  side-effect).

- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) and
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) throw
  informative error if used with ts objects
  ([\#2219](https://github.com/tidyverse/dplyr/issues/2219))

- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) recycles
  list columns of length 1
  ([\#2171](https://github.com/tidyverse/dplyr/issues/2171)).

- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) gives
  better error message when attempting to add a non-vector column
...
- Grouped
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) no
  longer converts character `NA` to empty strings
...
- Breaking change:
  [`bind_rows()`](https://dplyr.tidyverse.org/reference/bind_rows.md)
  and [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md)
...
- [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md) and
  [`bind_rows()`](https://dplyr.tidyverse.org/reference/bind_rows.md)
...
- [`first()`](https://dplyr.tidyverse.org/reference/nth.md),
  [`last()`](https://dplyr.tidyverse.org/reference/nth.md), and
  [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) have better
  default values for factor, Dates, POSIXct, and data frame inputs
  ([\#2029](https://github.com/tidyverse/dplyr/issues/2029)).
...
- Fixed segmentation faults in hybrid evaluation of
  ...
  [`nth()`](https://dplyr.tidyverse.org/reference/nth.md),
  [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md), and
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md). These
  functions now always fall back to the R implementation if called with
  arguments that the hybrid evaluator cannot handle
...
- [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) and
  [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) are more
  careful about proper data types of their return values
  ([\#2306](https://github.com/tidyverse/dplyr/issues/2306)).

- [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) ignores
  `NA` when computing group membership
  ([\#2564](https://github.com/tidyverse/dplyr/issues/2564)).

- [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) enforces
  integer `n` ([\#2162](https://github.com/tidyverse/dplyr/issues/2162),
...
- [`recode()`](https://dplyr.tidyverse.org/reference/recode.md) can now
  recode a factor to other types
  ([\#2268](https://github.com/tidyverse/dplyr/issues/2268))

- [`recode()`](https://dplyr.tidyverse.org/reference/recode.md) gains
...
- New
  [`is_grouped_df()`](https://dplyr.tidyverse.org/reference/grouped_df.md)
  alias to
  [`is.grouped_df()`](https://dplyr.tidyverse.org/reference/grouped_df.md).

- [`tbl_vars()`](https://dplyr.tidyverse.org/reference/tbl_vars.md) now
  has a `group_vars` argument set to `TRUE` by default. If `FALSE`,
  group variables are not returned.

- Fixed segmentation fault after calling
  [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) on an
  invalid grouped data frame
...
- Fixed undefined behavior for
  [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) on a
...
- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) once
  again ignores grouping
  ([\#1206](https://github.com/tidyverse/dplyr/issues/1206)).

- [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md) now
  only keeps the distinct variables. If you want to return all variables
  (using the first row for non-distinct values) use `.keep_all = TRUE`
...
- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.md) is a
  vectorised if statement: it’s a stricter (type-safe), faster, and more
  predictable version of
  [`ifelse()`](https://rdrr.io/r/base/ifelse.html). In SQL it is
  translated to a `CASE` statement.

- [`na_if()`](https://dplyr.tidyverse.org/reference/na_if.md) makes it
  easy to replace a certain value with an `NA`
...
- [`union_all()`](https://dplyr.tidyverse.org/reference/setops.md)
  ...
  [`combine()`](https://dplyr.tidyverse.org/reference/defunct.md) for
  vectors ([\#1045](https://github.com/tidyverse/dplyr/issues/1045)).
...
- A new family of functions replace
  ...
  [`funs()`](https://dplyr.tidyverse.org/reference/funs.md) (though this
  is only useful for local sources).
...
- [`glimpse()`](https://dplyr.tidyverse.org/reference/glimpse.md) is now
  a generic. The default method dispatches to
...
- [`compute()`](https://dplyr.tidyverse.org/reference/compute.md) gets
  new parameters `indexes` and `unique_indexes` that make it easier to
  add indexes ([\#1499](https://github.com/tidyverse/dplyr/issues/1499),
  [@krlmlr](https://github.com/krlmlr)).

- [`db_explain()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.md)
...
- [`src_sqlite()`](https://dplyr.tidyverse.org/reference/defunct.md) now
  uses a stricter quoting character, `` ` ``, instead of `"`. SQLite
...
3.  `sql_render()` iterates through the queries and generates the SQL,
    using generics (like
    [`sql_select()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.md))
...
- [`sql_join()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.md)
  ...
  [`sql_semi_join()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.md).
...
- `select_query()` gains a distinct argument which is used for
  ...
  [`distinct()`](https://dplyr.tidyverse.org/reference/distinct.md). It
  loses the `offset` argument which was never used (and hence never
  tested).

- `src_translate_env()` has been replaced by
  [`sql_translate_env()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.md)
...
- [`count()`](https://dplyr.tidyverse.org/reference/count.md) now adds
  additional grouping variables, rather than overriding existing
  ([\#1703](https://github.com/tidyverse/dplyr/issues/1703)).
  [`tally()`](https://dplyr.tidyverse.org/reference/count.md) and
  [`count()`](https://dplyr.tidyverse.org/reference/count.md) can now
  count a variable called `n`
  ([\#1633](https://github.com/tidyverse/dplyr/issues/1633)). Weighted
  [`count()`](https://dplyr.tidyverse.org/reference/count.md)/[`tally()`](https://dplyr.tidyverse.org/reference/count.md)
  ignore `NA`s
  ([\#1145](https://github.com/tidyverse/dplyr/issues/1145)).

- The progress bar in
  [`do()`](https://dplyr.tidyverse.org/reference/do.md) is now updated
  at most 20 times per second, avoiding unnecessary redraws
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) throws
  an error if you supply an named arguments. This is usually a type:
  `filter(df, x = 1)` instead of `filter(df, x == 1)`
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) now
  ...
  The [`select()`](https://dplyr.tidyverse.org/reference/select.md)
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) handles
  factors that are all `NA`
  ...
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) on a
  grouped data no longer groups grouping attributes
  ([\#1120](https://github.com/tidyverse/dplyr/issues/1120)).
  [`rowwise()`](https://dplyr.tidyverse.org/reference/rowwise.md) mutate
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) correctly
  handles grouped attributes
...
- [`rbind()`](https://rdrr.io/r/base/cbind.html) and
  ...
  [`grouped_df()`](https://dplyr.tidyverse.org/reference/grouped_df.md)
...
- Set operations
  ([`intersect()`](https://dplyr.tidyverse.org/reference/setops.md),
  [`union()`](https://dplyr.tidyverse.org/reference/setops.md) etc)
  respect coercion rules
  ([\#799](https://github.com/tidyverse/dplyr/issues/799)).
  [`setdiff()`](https://dplyr.tidyverse.org/reference/setops.md) handles
...
- Hybrid [`cummean()`](https://dplyr.tidyverse.org/reference/cumall.md)
  is more stable against floating point errors
  ([\#1387](https://github.com/tidyverse/dplyr/issues/1387)).

- Hybrid [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md)
  and [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md)
...
- [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) now supports
  negative indices to select from end, e.g. `nth(x, -2)` selects the 2nd
  value from the end of `x`
  ([\#1584](https://github.com/tidyverse/dplyr/issues/1584)).

- [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) can now
  also select bottom `n` values by passing a negative value to `n`
...
- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) and
  [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) work on
  empty data frames
  ([\#1142](https://github.com/tidyverse/dplyr/issues/1142)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md),
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md),
  [`slice()`](https://dplyr.tidyverse.org/reference/slice.md), and
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
...
- [`glimpse()`](https://dplyr.tidyverse.org/reference/glimpse.md) also
  prints out the number of variables in addition to the number of
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) can set
  to `NULL` the first column (used to segfault,
...
- The `Progress` bar used by
  [`do()`](https://dplyr.tidyverse.org/reference/do.md) now respects
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) silently
  drops columns corresponding to an NA
...
- Simplified code for
  [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and make
  sure they work properly on factors
...
- [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and
  [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md) for
  ...
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) once
  again overrides
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) instead
  of just the default method `lag.default()`. This is necessary due to
  changes in R CMD check. To use the lag function provided by another
  package, use `pkg::lag`.
...
- [`vignette("two-table")`](https://dplyr.tidyverse.org/articles/two-table.md)
...
- [`data_frame()`](https://tibble.tidyverse.org/reference/deprecated.html)
  (and
  [`as_data_frame()`](https://tibble.tidyverse.org/reference/deprecated.html)
  & [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md)) now
  explicitly forbid columns that are data frames or matrices
  ([\#775](https://github.com/tidyverse/dplyr/issues/775)). All columns
  must be either a 1d atomic vector or a 1d list.

- [`do()`](https://dplyr.tidyverse.org/reference/do.md) uses lazyeval to
  correctly evaluate its arguments in the correct environment
  ([\#744](https://github.com/tidyverse/dplyr/issues/744)), and new
  [`do_()`](https://dplyr.tidyverse.org/reference/defunct-lazyeval.md)
  ...
  [`do()`](https://dplyr.tidyverse.org/reference/do.md) on grouped data
  tables now passes in all columns (not all columns except grouping
  vars) ([\#735](https://github.com/tidyverse/dplyr/issues/735), thanks
  to [@kismsu](https://github.com/kismsu)).
  [`do()`](https://dplyr.tidyverse.org/reference/do.md) with database
  tables no longer potentially includes grouping variables twice
  ([\#673](https://github.com/tidyverse/dplyr/issues/673)). Finally,
  [`do()`](https://dplyr.tidyverse.org/reference/do.md) gives more
  consistent outputs when there are no rows or no groups
  ([\#625](https://github.com/tidyverse/dplyr/issues/625)).

- [`first()`](https://dplyr.tidyverse.org/reference/nth.md) and
  [`last()`](https://dplyr.tidyverse.org/reference/nth.md) preserve
...
- Overhaul of single table verbs for data.table backend. They now all
  ...
  [`n()`](https://dplyr.tidyverse.org/reference/context.md) now works in
  all verbs ([\#579](https://github.com/tidyverse/dplyr/issues/579)).
...
- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) works for
  data tables ([\#717](https://github.com/tidyverse/dplyr/issues/717)).
...
- Functions that need to combine multiple results into a single column
  (e.g. [`join()`](https://dplyr.tidyverse.org/reference/mutate-joins.md),
  [`bind_rows()`](https://dplyr.tidyverse.org/reference/bind_rows.md)
  and
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md))
  ...
  [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md) is
  more careful about `NA`, e.g. the decision on the result type will be
  delayed until the first non NA value is returned
...
- A number of functions gained new or improved hybrid handlers:
  ...
  implementation of
  [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) falls back to
  R evaluation when `n` is not a length one integer or numeric,
...
- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) on a
  data table preserves original order of the rows
...
- [`row_number()`](https://dplyr.tidyverse.org/reference/row_number.md),
  ...
  [`percent_rank()`](https://dplyr.tidyverse.org/reference/percent_rank.md),
  [`dense_rank()`](https://dplyr.tidyverse.org/reference/row_number.md),
  [`ntile()`](https://dplyr.tidyverse.org/reference/ntile.md) and
  [`cume_dist()`](https://dplyr.tidyverse.org/reference/percent_rank.md)
...
- [`between()`](https://dplyr.tidyverse.org/reference/between.md) vector
  function efficiently determines if numeric values fall in a range, and
  is translated to special form for SQL
  ([\#503](https://github.com/tidyverse/dplyr/issues/503)).

- [`count()`](https://dplyr.tidyverse.org/reference/count.md) makes it
  even easier to do (weighted) counts
...
- Set operations,
  [`intersect()`](https://dplyr.tidyverse.org/reference/setops.md),
  [`union()`](https://dplyr.tidyverse.org/reference/setops.md) and
  [`setdiff()`](https://dplyr.tidyverse.org/reference/setops.md) now
...
- Joins
  (e.g. [`left_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.md),
  [`inner_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.md),
...
- [`n_groups()`](https://dplyr.tidyverse.org/reference/group_data.md)
...
- [`rename()`](https://dplyr.tidyverse.org/reference/rename.md) makes it
  easy to rename variables - it works similarly to
  [`select()`](https://dplyr.tidyverse.org/reference/select.md) but it
  preserves columns that you didn’t otherwise touch.

- [`slice()`](https://dplyr.tidyverse.org/reference/slice.md) allows you
  to selecting rows by position
  ...
  like [`n()`](https://dplyr.tidyverse.org/reference/context.md).
...
- `show_sql()` and `explain_sql()` and matching global options
  ...
  use [`show_query()`](https://dplyr.tidyverse.org/reference/explain.md)
  and [`explain()`](https://dplyr.tidyverse.org/reference/explain.md).
...
- [`do()`](https://dplyr.tidyverse.org/reference/do.md) now displays the
  progress bar only when used in interactive prompts and not when
  knitting ([\#428](https://github.com/tidyverse/dplyr/issues/428),
  [@jimhester](https://github.com/jimhester)).

- [`glimpse()`](https://dplyr.tidyverse.org/reference/glimpse.md) now
  prints a trailing new line
  ([\#590](https://github.com/tidyverse/dplyr/issues/590)).

- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) has
  more consistent behaviour when grouping by constants: it creates a new
...
- Now instead of overriding
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md), dplyr
  overrides `lag.default()`, which should avoid clobbering lag methods
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) gains
  ...
  [`select()`](https://dplyr.tidyverse.org/reference/select.md) so that
  you can now create variables called `val`
  ([\#564](https://github.com/tidyverse/dplyr/issues/564)).

- Switched from RC to R6.

- [`tally()`](https://dplyr.tidyverse.org/reference/count.md) and
  [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) work
...
- When [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md)
...
- [`order_by()`](https://dplyr.tidyverse.org/reference/order_by.md) now
  works in conjunction with window functions in databases that support
  them.
...
- Hybrid evaluation bugs fixed:
  ...
  - [`nth()`](https://dplyr.tidyverse.org/reference/nth.md) now
...
- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) keeps
  the grouping structure of grouped data
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) asserts
  all variables are white listed
  ([\#566](https://github.com/tidyverse/dplyr/issues/566)).

- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) makes a
  `rowwise_df` when given a `rowwise_df`
  ([\#463](https://github.com/tidyverse/dplyr/issues/463)).

- `rbind_all()` creates `tbl_df` objects instead of raw `data.frame`s.

- If [`select()`](https://dplyr.tidyverse.org/reference/select.md)
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) works
  for on zero-row grouped data frame, and with list columns
...
- [`summarise()`](https://dplyr.tidyverse.org/reference/summarise.md)
  and [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md)
...
[`do()`](https://dplyr.tidyverse.org/reference/do.md) also has an
...
- [`glimpse()`](https://dplyr.tidyverse.org/reference/glimpse.md) makes
  it possible to see all the columns in a tbl, displaying as much data
  for each variable as can be fit on a single line.
...
- [`compute()`](https://dplyr.tidyverse.org/reference/compute.md) gains
  `temporary` argument so you can control whether the results are
  temporary or permanent
  ([\#382](https://github.com/tidyverse/dplyr/issues/382),
  [@cpsievert](https://github.com/cpsievert))

- [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.md) now
  defaults to `add = FALSE` so that it sets the grouping variables
...
- [`explain()`](https://dplyr.tidyverse.org/reference/explain.md) is now
  generic.
...
- Special case for call to
  [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) on a
  grouped data frame with no arguments.
...
- [`top_n()`](https://dplyr.tidyverse.org/reference/top_n.md) returns
  `n` rows instead of `n - 1`
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) actually
  renames columns in a data table
...
- [`select()`](https://dplyr.tidyverse.org/reference/select.md) is
...
- [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) now
  ...
  continue to use
  [`filter()`](https://dplyr.tidyverse.org/reference/filter.md) function
  with numeric inputs
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md)
  ...
  [`mutate.data.frame()`](https://dplyr.tidyverse.org/reference/mutate.md)
  correctly mutates the same variable repeatedly
  ([\#243](https://github.com/tidyverse/dplyr/issues/243)).

- [`lead()`](https://dplyr.tidyverse.org/reference/lead-lag.md) and
  [`lag()`](https://dplyr.tidyverse.org/reference/lead-lag.md) preserve
  attributes, so they now work with dates, times and factors
  ([\#166](https://github.com/tidyverse/dplyr/issues/166)).

- [`n()`](https://dplyr.tidyverse.org/reference/context.md) never
  accepts arguments
...
- The hybrid evaluator did not handle some expressions correctly, for
  ...
  [`n()`](https://dplyr.tidyverse.org/reference/context.md) was not
  substituted correctly. It also correctly processes `$`
  ([\#278](https://github.com/tidyverse/dplyr/issues/278)).

- [`arrange()`](https://dplyr.tidyverse.org/reference/arrange.md) checks
  that all columns are of supported types
...
- [`tally()`](https://dplyr.tidyverse.org/reference/count.md) gains
  `sort` argument to sort output so highest counts come first
  ([\#173](https://github.com/tidyverse/dplyr/issues/173)).

- `ungroup.grouped_df()`,
  [`tbl_df()`](https://dplyr.tidyverse.org/reference/defunct.md),
...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.md) gives
  informative error message on unsupported types
