...
test_that(".dot argument works correctly (PR #2110)", {
  ...
  expect_equal(
    ...
    recode(x1, .default = NA_character_, splice(list(a = "apple", b = "banana")))
  )
  expect_equal(
    recode(x1, a = "apple", b = "banana", .default = NA_character_),
    recode(x1, a = "apple", .default = NA_character_, splice(list(b = "banana")))
  )
  expect_equal(
    recode(x2, "1" = 4, "2" = 5, .default = NA_real_),
    recode(x2, .default = NA_real_, splice(list("1" = 4, "2" = 5)))
  )
  expect_equal(
    recode(x2, "1" = 4, "2" = 5, .default = NA_real_),
    recode(x2, "1" = 4, .default = NA_real_, splice(list("2" = 5)))
  )
})
